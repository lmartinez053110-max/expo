...
export declare function tuplesToEncodedMap(opts: {
    filename: string;
    source: string;
    tuples: readonly MetroSourceMapSegmentTuple[];
}): EncodedTransformerSourceMap;
export declare function decodedMapToTuples(input: {
    mappings: string;
    names: readonly string[];
}): MetroSourceMapSegmentTuple[];
export declare function rawMappingsToTuples(rawMappings: readonly BabelSourceMapSegment[]): MetroSourceMapSegmentTuple[];
